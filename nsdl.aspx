<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="nsdl.aspx.cs" Inherits="nsdl" %>
...
<!-- BREADCRUMB-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">NSDL Pan Card </li>
                                        </ul>
                                    </div>
  ...
  <div class="wrapper wrapper--w680">
         ...
         <div class="col-md-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"> Nsdl Agency Pancard Report 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText=" Pen Details" Visible="true">
            <ItemTemplate>
                <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
             </ItemTemplate>
            </asp:TemplateField>
             <asp:TemplateField HeaderText="Documents" Visible="true">
            <ItemTemplate>
