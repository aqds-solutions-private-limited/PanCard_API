<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="PenCardApi_Solutions.WebForm4" %>
...
<!-- BREADCRUMB-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Setting &nbsp; / &nbsp; Update Profile</li>
                                        </ul>
                                    </div>
    ...
    <div class="col-md-12">
        ...
        <asp:Button runat = "server" 
            CssClass="btn btn-inverse bg-blue btn-lg btn-block" ID="Button1" 
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                       <asp:Label ID="Label10" runat="server"><b>Aadhar Number</b> </asp:Label>
                        <asp:TextBox runat="server" ID = "textbox7" CssClass="form-control" value="" placeholder = "Enter Value" TextMode = "Number" MaxLength="12" minlength="12" required></asp:TextBox>
