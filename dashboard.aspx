<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="PenCardApi_Solutions.WebForm1" %>
...
<head runat="server">
 ...
 <!-- Required meta tags-->
    ...
    <link href="fonts/font-awesome-5/css/fontawesome-all.min.css" rel="stylesheet" media="all" />
...
<body class="animsition">
  <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    ...
                    <h4 class="name"><asp:Label ID="Label1" runat="server" Text=""></asp:Label></h4>
                    <a href="#">Sign out</a>
                </div>
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li>
                                <a href="#">
                                    <i class="fas fa-money"></i>Load Wallet</a>
                              </li>
                            <li>
                                <a href="#">
                                    <i class="fas fa-file-text"></i>Account Statement</a>
                            </li>
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc"> Total Distributors</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number">1</h2>
                                    <span class="desc"> Total Retailers </span>
                                    <div class="icon">
                                        <i class="zmdi zmdi-account-o"></i>
                                    </div>
                                </div>
    ...
    <script type="text/javascript" src="vendor/vector-map/jquery.vmap.js"></script>
    <script type="text/javascript" src="vendor/vector-map/jquery.vmap.min.js"></script>
    <script type="text/javascript" src="vendor/vector-map/jquery.vmap.sampledata.js"></script>
    <script type="text/javascript" src="vendor/vector-map/jquery.vmap.world.js"></script>
